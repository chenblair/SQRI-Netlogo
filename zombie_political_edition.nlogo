to setup
  ...
  ask n-of (Population * (Percent-republicans / 100)) turtles [set color red]
  ask n-of (Population * (Percent-democrats / 100)) turtles with [color = white] [set color blue]
  reset-ticks
end
to go
  let humans turtles with [color = white]
  ...
  ask humans [
    if any? politicians in-radius 4 [
      let closest min-one-of politicians [distance myself]
      face closest
